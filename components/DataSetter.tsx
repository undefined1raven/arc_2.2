...
function DataSetter() {
  ...
  useEffect(() => {
    // db.runAsync("DELETE FROM dayPlannerChunks;");
    ...
    //   const dbSavePromises: any[] = [];
    //   encryptedChunks.map((x, ix) => {
    //     const encryptedContent = {
    //       cipher: x.payload.cipher,
    //       iv: x.payload.iv,
    //     };
    //     console.log("ENCR TTT", encryptedContent.iv, ix);
    //   });
    ...
    //       newChunk.tx,
    //       dayStr,
    //       encryptedContent.cipher.length
    //     );
